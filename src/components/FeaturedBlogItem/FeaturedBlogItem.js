...
import placeHolder from "../../../src/assets/zaher_hage.jpg";
      ...
      <CardActionArea className={classes.Overlay}>
        <CardContent className={classes.CardContent}>
          ...
          <Typography variant="h5" className={classes.Desc}>
            This is a test description for a Featured blog item. hur dee der dee
            burp dee turd merd cheese curd.
          </Typography>
          <Typography
            variant="subtitle1"
            className={classes.ContinueReadingText}
            color="inherit"
          >
            Continue reading...
          </Typography>
